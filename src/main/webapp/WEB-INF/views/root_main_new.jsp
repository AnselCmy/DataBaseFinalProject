...
<div ng-app="payroll_app" ng-controller="payroll_controller">
    <div class="navbar navbar-fixed-top">
        <div class="navbar-inner">
            <div class="container">
                ...
                </a><a class="brand" href="index.html">工资管理系统——管理者面板</a>
                    ...
                    <ul class="nav pull-right">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <i class="fa fa-user fa-lg" aria-hidden="true"></i>&nbsp; {{ currEName }}<b class="caret"></b>
                            </a>
                            <ul class="dropdown-menu">
    ...
    <div class="subnavbar">
        <div class="subnavbar-inner">
            <div class="container">
                <ul class="mainnav">
                    <li class="active"><a href="charts.html"><i class="icon-bar-chart"></i><span>图表</span> </a>
                    </li>
