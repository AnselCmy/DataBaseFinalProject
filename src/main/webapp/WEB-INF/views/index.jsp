            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="#"><i class="fa fa-user fa-fw"></i> {{ currEName }}</a>
                        </li>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="index.html"><i class="fa fa-dashboard"></i> 管理面板</a>
                    </li>
                    <li>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="entity in allEntity">
                                                <td ng-repeat="col in entity">
                                                    {{ col }}
                                                </td>
                                            </tr>
                                        </tbody>
...
{{ currEName }}
    ...
    <script>
        ...
        app.controller("payroll_controller", function($scope){
            $scope.currENo = "${currENo}";
            $scope.currEName = "${currEName}";
            $scope.allEntity = JSON.parse('${allEntity}');
        });
    </script>
</body>
