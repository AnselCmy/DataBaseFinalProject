...
<head>
    ...
    <link href="/lib/css/font-awesome.css" rel="stylesheet" />
     <!-- Morris Chart Styles-->
    <link href="/lib/js/morris-0.4.3.min.css" rel="stylesheet" />
    <!-- Custom Styles-->
    <link href="/lib/css/custom-styles.css" rel="stylesheet" />
     <!-- Google Fonts-->
...
<body>
    ...
    <!-- Chart Js -->
    <script src="/lib/js/Chart1.min.js"></script>
    <script src="/lib/js/chartjs.js"></script>
     <!-- Morris Chart Js -->
     <script src="/lib/js/morris/raphael-2.1.0.min.js"></script>
    <script src="/lib/js/morris/morris.js"></script>
      <!-- Custom Js -->
    <script src="/lib/js/custom-scripts.js"></script>
